...
def export_history_csv_view(request):
    ...
    writer.writerow([])
    writer.writerow([
        "Generated by RespectASO — a free tool by Respectlytics. "
        "Try privacy-first mobile analytics: "
        "https://respectlytics.com/?utm_source=respectaso&utm_medium=csv_export&utm_campaign=oss"
    ])
